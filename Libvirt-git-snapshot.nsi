...
!define APPVERSION "git-snapshot"
...
Section "Virsh" Section1
	...
	; Create the shortcuts - hard coded to all users for the moment
...
Section "Python 2.6 bindings" Section4
	...
	File "${MSYS_SETUP_REPO_DIR}\msys\gather\libvirt\python26\libvirt.py"
	File "${MSYS_SETUP_REPO_DIR}\msys\gather\libvirt\python26\libvirtmod.pyd"
	
	WriteRegStr HKLM "Software\Python\PythonCore\2.6\PythonPath\libvirt" "" "$INSTDIR\python26"

SectionEnd

Section "Python 2.7 bindings" Section5
	...
	File "${MSYS_SETUP_REPO_DIR}\msys\gather\libvirt\python27\libvirt.py"
	File "${MSYS_SETUP_REPO_DIR}\msys\gather\libvirt\python27\libvirtmod.pyd"
	
	WriteRegStr HKLM "Software\Python\PythonCore\2.7\PythonPath\libvirt" "" "$INSTDIR\python27"
...
!insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
	...
	!insertmacro MUI_DESCRIPTION_TEXT ${Section4} "Python 2.6 bindings for Libvirt"
	!insertmacro MUI_DESCRIPTION_TEXT ${Section5} "Python 2.7 bindings for Libvirt"
...
Section Uninstall
  ...
  ; Delete "$DESKTOP\Virsh.lnk"
	Delete "$SMPROGRAMS\Libvirt\Readme.lnk"
	...
	; Clean up Python 2.6 bindings
	Delete "$INSTDIR\python26\libvirt.py"
	Delete "$INSTDIR\python26\libvirtmod.pyd"
	DeleteRegKey HKLM "Software\Python\PythonCore\2.6\PythonPath\libvirt"

	; Clean up Python 2.7 bindings
	Delete "$INSTDIR\python27\libvirt.py"
	Delete "$INSTDIR\python27\libvirtmod.pyd"
	DeleteRegKey HKLM "Software\Python\PythonCore\2.7\PythonPath\libvirt"
